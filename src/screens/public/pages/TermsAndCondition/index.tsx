export const TermsAndConditionPage = () => {
  return (
    <div className="TermsAndCondition grid max-width-80 mx-auto px-4 sm:px-6 pt-8">
      <div className="col-12">
        <h1 className="effectPrimary m-0">Terms of Service Agreement</h1>
      </div>
      <div className="col-12 text-white">
        ...
        <p>
          ...
          <b>Terms</b>") is a legal agreement between you and The Event Jet
          (hereinafter <b>"The Event Jet</b>"), a company duly organized and
          validly existing, located at , , . This Agreement annuls and voids all
          previous agreements.
        </p>
        <h4>OVERVIEW</h4>
        <p>
          The Site (Www.theeventjet.com) is operated by The Event Jet.
          Throughout the Site, the terms "<b>we</b>", "<b>us</b>" and "
          <b>our</b>" refer to The Event Jet. The Event Jet offers this Site,
        ...
        <ol>
          ...
          <li>
            <p>Deactivate or delete your accounts;</p>
          </li>
          <li>
            <p>
            ...
            <p>
              ...
              on the Site. The Event Jet content is not for resale. Use of the
              Site does not entitle users to make any unauthorized use of any
              ...
              permission of The Event Jet and the copyright owner. You agree
              ...
              the intellectual property of The Event Jet or our licensors except
              as expressly authorized by these Terms.
            </p>
            <h4>SECTION 2 - CREATING AN ACCOUNT</h4>
            <p>
              Once you create an account with us, you are registered on the The
              Event Jet Site. The terms "member," "membership," and "account"
              all refer to this registration as a member on The Event Jet's
              Site. If you are merely surfing or browsing through the Site and
              have not yet created an account, your use of the Site is still
            ...
            <p>
              ...
              responsibility it is important for you to keep your username
              ...
              The Event Jet is not responsible for third party access to your
        ...
        <p>
          ...
          inaccurate or incomplete nature, The Event Jet will have sufficient
          ...
          or future use of The Event Jet Services, or any portion thereof.
        </p>
        ...
        <p>
          ...
          available by way of the The Event Jet Services, and as such, we do not
          ...
          otherwise made available by The Event Jet.
        </p>
        <p>
          Furthermore, you herein agree not to make use of The Event Jet's
        ...
        <ol>
          ...
          <li>
            <p>causing harm to minors in any manner whatsoever;</p>
          </li>
          <li>
            <p>
              impersonating any individual or entity, including, but not limited
              to, any The Event Jet officials, forum leaders, guides or hosts or
              falsely stating or otherwise misrepresenting any affiliation with
          ...
          <li>
            <p>
              ...
              code, any files and/or programs which
            </p>
            <p>
              have been designed to interfere, destroy and/or limit the
          ...
          <li>
            <p>
              interfering with or disrupting any The Event Jet Services, servers
              and/or networks that may be connected or related to our website,
              including, but not limited to, the use of any device software
          ...
          <li>
            ...
            <p>
              international law, including, but not limited to, rules,
              guidelines, and/or regulations decreed by the U.S. Securities and
              Exchange Commission, in addition to any rules of any nation or
              other securities exchange, that would include without limitation,
        ...
        <p>
          The Event Jet herein reserves the right to pre-screen, refuse and/or
        ...
        <p>
          The Event Jet herein reserves the right to access, preserve and/or
        ...
        <ol>
          <li>
            <p>compliance with any legal process;</p>
          </li>
          <li>
            <p>enforcement of the Terms;</p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>responding to requests for customer service; or</p>
          </li>
          <li>
            <p>
              protecting the rights, property or the personal safety of The
              Event Jet, its visitors, users and members, including the general
              public.
            </p>
          </li>
        </ol>
        <p>
          The Event Jet herein reserves the right to include the use of security
          ...
          to usage guidelines and regulations established by The Event Jet or
          any other content providers supplying content services to The Event
          Jet. You are hereby prohibited from making any attempt to override or
        ...
        <h4>SECTION 4 - GLOBAL USE; EXPORT/IMPORT COMPLIANCE</h4>
        <p>
          ...
          <span>http://www.access.gpo.gov/bis/ear/ear_data.html</span>), as well
          as the sanctions control program of the United States (
          <span>http://www.treasury.gov/resource-center/</span>
          <span>sanctions/Programs/Pages/Programs.aspx</span>). Furthermore, you
        ...
        <ol>
          <li>
            <p>
              ...
              <span>http://www.bis.doc.gov/</span>
              <a
                href="http://www.bis.doc.gov/complianceandenforcement/liststocheck.htm"
                target="_blank"
              ></a>
              <span>complianceandenforcement/liststocheck.htm</span>) nor a
              member of any other government which may be part of an
        ...
        <h4>SECTION 5 - SUBMITTED CONTENT</h4>
        <p>
          The Event Jet shall not lay claim to ownership of any content
          ...
          grant and allow for The Event Jet the below listed worldwide, royalty-
          free and non-exclusive licenses, as applicable:
        </p>
        <ol>
          <li>
            <p>
              The content submitted or made available for inclusion on the
              publicly accessible areas of The Event Jet's Sites, the license
              ...
              so long as you are a member of The Event Jet's sites, and shall
          ...
          <li>
            <p>
              ...
              for inclusion on the publicly accessible areas of The Event Jet's
              ...
              be available so long as you are a member of The Event Jet's sites
          ...
          <li>
            <p>
              ...
              the publicly accessible areas of The Event Jet's sites, the
        ...
        <p>
          ...
          Event Jet's Sites are those such areas of our network properties which
          are meant to be available to the general public, and which would
        ...
        <p className="s2">CONTRIBUTIONS TO COMPANY WEBSITE</p>
        <p>
          The Event Jet may provide an area for our user and members to
          contribute feedback to our website. When you submit ideas, documents,
          suggestions and/or proposals ("<b>Contributions</b>") to our site, you
        ...
        <ol>
          ...
          <li>
            <p>
              The Event Jet shall not be liable or under any obligation to
              ensure or maintain confidentiality, expressed or implied, related
              to any Contributions;
            </p>
          </li>
          <li>
            <p>
              The Event Jet shall be entitled to make use of and/or disclose any
          ...
          <li>
            <p>
              ...
              sole property of The Event Jet; and
            </p>
          </li>
          <li>
            <p>
              The Event Jet is under no obligation to either compensate or
              provide any form of reimbursement in any manner or nature.
            </p>
          </li>
        </ol>
        <h4>SECTION 6 - INDEMNITY</h4>
        <p>
          All users and/or members agree to insure and hold The Event Jet, our
          ...
          through our Services, the use of The Event Jet Services or your
          connection with these Services, your violations of the Terms of
          Service and/ or your violation of any such rights of another person.
        </p>
        <h4>SECTION 7 - COMMERCIAL REUSE OF SERVICES</h4>
        <p>
          ...
          use of, or access to The Event Jet's sites.
        </p>
        <h4>SECTION 8 - MODIFICATIONS</h4>
        <p>
          The Event Jet reserves the right at any time it may deem fit, to
        ...
        <p>
          As a member of Www.theeventjet.com, you may cancel or terminate your
          account, associated email address and/or access to our Services by
          submitting a cancellation or termination request to .
        </p>
        <p>
          As a member, you agree that The Event Jet may, without any prior
        ...
        <ol>
          ...
          <li>
            <p>unexpected technical or security issues and/or problems;</p>
          </li>
          <li>
            <p>any extended periods of inactivity;</p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              connection with your Www.theeventjet.com account Services.
            </p>
          </li>
        </ol>
        <p>
        ...
        <p>
          The termination of your account with Www.theeventjet.com shall include
        ...
        <h4>SECTION 10 - LINKS</h4>
        <p>
          Either The Event Jet or any third parties may provide links to other
          ...
          you acknowledge and agree that The Event Jet shall not be responsible
        ...
        <h4>SECTION 11 - PROPRIETARY RIGHTS</h4>
        <p>
          You do hereby acknowledge and agree that The Event Jet's Services and
          ...
          applicable law or as authorized by The Event Jet or such applicable
          ...
          plagiaristic works which are based on The Event Jet Services (e.g.
          Content or Software), in whole or part.
        </p>
        <p>
          The Event Jet hereby grants you a personal, non-transferable and
          ...
          which is provided by The Event Jet for use in accessing our Services.
        </p>
        <h4>SECTION 12 - WARRANTY DISCLAIMERS</h4>
        <p>YOU HEREIN EXPRESSLY ACKNOWLEDGE AND AGREE THAT:</p>
        <ol>
          <li>
            <p>
              THE USE OF THE EVENT JET SERVICES AND SOFTWARE ARE AT THE SOLE
              RISK BY YOU. OUR SERVICES AND SOFTWARE SHALL BE PROVIDED ON AN "AS
              IS" AND/OR "AS AVAILABLE" BASIS. THE EVENT JET AND OUR
          ...
          <li>
            <p>
              THE EVENT JET AND OUR SUBSIDIARIES, OFFICERS, EMPLOYEES, AGENTS,
              PARTNERS AND LICENSORS MAKE NO SUCH WARRANTIES THAT
            </p>
            <p>
              (i) THE EVENT JET SERVICES OR SOFTWARE WILL MEET YOUR
              REQUIREMENTS; (ii) THE EVENT JET SERVICES OR SOFTWARE SHALL BE
              UNINTERRUPTED, TIMELY, SECURE OR ERROR-FREE; (iii) THAT SUCH
              RESULTS WHICH MAY BE OBTAINED FROM THE USE OF THE THE EVENT JET
              SERVICES OR SOFTWARE WILL BE ACCURATE OR RELIABLE; (iv) QUALITY OF
              ANY PRODUCTS, SERVICES, ANY INFORMATION OR OTHER MATERIAL WHICH
          ...
          <li>
            <p>
              ...
              WAY OF THE EVENT JET SERVICES OR SOFTWARE SHALL BE ACCESSED BY
              YOUR SOLE DISCRETION AND SOLE RISK, AND AS SUCH YOU SHALL BE
          ...
          <li>
            <p>
              ...
              THAT MAY BE OBTAINED BY YOU FROM THE EVENT JET OR BY WAY OF OR
        ...
        <h4>SECTION 13 - LIMITATION OF LIABILITY</h4>
        <p>
          YOU EXPLICITLY ACKNOWLEDGE, UNDERSTAND AND AGREE THAT THE EVENT JET
        ...
        <ol>
          <li>
            <p>THE USE OR INABILITY TO USE OUR SERVICE;</p>
          </li>
          <li>
            <p>THE COST OF PROCURING SUBSTITUTE GOODS AND SERVICES;</p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>STATEMENTS OR CONDUCT OF ANY SUCH THIRD PARTY ON OUR SERVICE;</p>
          </li>
          <li>
            <p>AND ANY OTHER MATTER WHICH MAY BE RELATED TO OUR SERVICE.</p>
          </li>
        </ol>
        <h4>SECTION 14 - RELEASE</h4>
        <p>
          In the event you have a dispute, you agree to release The Event Jet
        ...
        <h4>SECTION 15 - NOTICE</h4>
        <p>
          The Event Jet may furnish you with notices, including those with
        ...
        <p>
          may be herein after developed. Any such notices may not be received if
          you violate any aspects of the Terms by accessing our Services in an
        ...
        <h4>SECTION 16 - INTELLECTUAL PROPERTY RIGHTS</h4>
        <p>
          You herein acknowledge, understand and agree that all of the The Event
          Jet trademarks, copyright, trade name, service marks, and other The
          Event Jet logos and any brand features, and/or product and service
          names are trademarks and as such, are and shall remain the property of
          The Event Jet. You herein agree not to display and/or use in any
          manner the The Event Jet logo or marks without obtaining The Event
          Jet's prior written consent.
        </p>
        <p>
          The Event Jet will always respect the intellectual property of others,
          and we ask that all of our users do the same. With regards to
          appropriate circumstances and at its sole discretion, The Event Jet
        ...
        <p>
          The The Event Jet agent for notice of claims of copyright or other
        ...
        <p>
          ...
          Event Jet and shall govern the use of our Services, superseding any
          prior version of this Agreement between you and us with respect to The
          Event Jet Services. You may also be subject to additional terms and
          conditions that may apply when you use or purchase certain other The
          Event Jet Services, affiliate Services, third-party content or
          third-party software.
        </p>
        <h4>SECTION 18 - CHOICE OF LAW AND FORUM</h4>
        <p>
          It is at the mutual agreement of both you and The Event Jet with
          ...
          to its conflict of law provisions and that any and all claims, causes
          of action and/or disputes, arising out of or relating to the
          Agreement, or the relationship between you and The Event Jet, shall be
          filed within the courts having jurisdiction within the County of
          Hillsborough, Florida or the U.S. District Court located in said
          state. You and The Event Jet agree to submit to the jurisdiction of
          the courts as previously mentioned, and agree to waive any and all
          objections to the exercise of jurisdiction over the parties by such
          courts and to venue in such courts.
        </p>
        <h4>SECTION 19 - WAIVER AND SEVERABILITY OF TERMS</h4>
        <p>
          At any time, should The Event Jet fail to exercise or enforce any
          right or provision of the Agreement, such failure shall not constitute
        ...
        <h4>SECTION 20 - NO RIGHT OF SURVIVORSHIP NON- TRANSFERABILITY</h4>
        <p>
          ...
          account shall terminate upon your death. Upon receipt of
        </p>
        <p>
          a copy of a death certificate, your account may be terminated and all
          contents therein permanently deleted.
        </p>
        <h4>SECTION 21 - STATUTE OF LIMITATIONS</h4>
        <p>
          ...
          to the use of our Services or the Agreement must be filed within 2
          year(s) after said claim or cause of action arose or shall be forever
          barred.
        </p>
        <h4>SECTION 22 - VIOLATIONS</h4>
        <p>
          Please report any and all violations of this Agreement to The Event
          Jet as follows: Mailing Address:
        </p>
        <p>The Event Jet</p>
        <h4>SECTION 23 - GOVERNMENT REQUESTS</h4>
        <p>
        ...
        <h4>SECTION 24 - FOREIGN ACCESS OF SITE</h4>
        <p>
          The Site is controlled, operated and administered by The Event Jet
          ...
          local laws. You agree that you will not use The Event Jet's content
          accessed through the Site in any country or in any manner prohibited
          by any applicable laws, restrictions or regulations.
        </p>
        <h4>SECTION 25 - ERRORS, INACCURACIES AND OMISSIONS</h4>
        <p>
          ...
          information or cancel orders if any
        </p>
        <p>
